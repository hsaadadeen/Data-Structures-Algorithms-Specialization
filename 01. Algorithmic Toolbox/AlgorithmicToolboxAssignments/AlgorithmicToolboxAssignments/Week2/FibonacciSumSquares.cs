...
namespace AlgorithmicToolboxAssignments.Week2
{
    class FibonacciSumSquares
    {
        ...
        //    long c = GetFibonacciSumSquareLastDigit(n);
        //    Console.WriteLine(c);
        //}

        private static long GetFibonacciSumSquareLastDigit(long n)
        {
            long k = GetPisanoPeriodHuge(n);
            long l = GetPisanoPeriodHuge(n + 1);
        ...
        private static void StressTest(int n)
        {
            ...
            while (true)
            {
                ...
                var result1 = GetFibonacciSumSquaresNaive(n);
                var result2 = GetFibonacciSumSquareLastDigit(n);
                if (result1 == result2)
